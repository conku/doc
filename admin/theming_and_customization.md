...
[A default implemention](https://github.com/conku/assetfs/blob/master/filesystem.go) of `AssetFS` is looking up templates from the filesystem with pre-registered view paths.

it includes:

* {current_path}/app/views/qor
* {current_path}/vendor/github.com/conku/admin/views
* $GOPATH/src/github.com/conku/admin/views

Checkout [AssetFS](http://github.com/conku/assetfs) for more details
...
QOR Admin is using go templates to render admin interface, default templates could be found from https://github.com/conku/admin/tree/master/views
